...
public class PembayaranParkir19 {

    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        int jenisKendaraan, durasi, total = 0;
        double totalPembayaraan = 0;
        ...
        while (true) {
            ...
            totalPembayaraan += pembayaran;
            System.out.printf("Total pembayaraan untuk kendaraan: Rp %.2f%n", pembayaran);
        }
        System.out.printf("Total pembayaran parkir keseluruhan: Rp %.2f%n", totalPembayaraan);
    }
